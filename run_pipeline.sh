...
# =====================================================
if [[ ! -f "$RESULTS_DIR/qc_before/multiqc_report.html" ]]; then
...
# [3] Read processing
# =====================================================
if [[ ! -d "$RESULTS_DIR/processed_reads" ]]; then
...
# [4] Genome assembly
# =====================================================
if [[ ! -f "$RESULTS_DIR/assembly/03_hybrid/assembly.fasta" ]]; then
...
# =====================================================
if compgen -G "$RESULTS_DIR/quality/coverage/*/*depth*" > /dev/null; then
...
# [6] Genome annotation
# =====================================================
if [[ -f "$RESULTS_DIR/annotation/prokka/03_hybrid/*.gff" ]] 2>/dev/null; then
...
# =====================================================
if [[ -f "$RESULTS_DIR/amr/assembly_level/abricate_assembly_summary.tsv" ]]; then
